...
<div>
  ...
  <section id="code" style="text-align: center; margin: 0px auto; margin-top: 2em">
    <section style="border-radius: 4px; border: 1px solid #757576; display: inline-block; padding: 5px 20px;">
      <span style="font-size: 18px; color: #595959;">代码</span>
    </section>
  </section>
  <section style="margin-top: 1.5em;">
  ...
  return fibonacci(n - 1) + fibonacci(n - 2)
    ...
    <div style="font-size: 12px; color: gray; margin-top: 5px; text-align: center">长按复制代码</div>
  </section>
  <section id="latex" style="text-align: center; margin: 0px auto; margin-top: 2em">
    <section style="border-radius: 4px; border: 1px solid #757576; display: inline-block; padding: 5px 20px;">
      <span style="font-size: 18px; color: #595959;">公式</span>
    </section>
  </section>
  <section>
    <div style="text-align:center;margin-top:20px">求根公式：$x=\\frac{-b \\pm \\sqrt{b^{2} - 4ac}}{2a}$</div>
    <div style="text-align:center;margin-top:20px">$A=\\begin{bmatrix}
      a_{11} & \\dots & a_{1n} \\\\
      \\vdots & \\ddots & \\vdots \\\\
      a_{n1} & \\dots & a_{nn} 
    \\end{bmatrix}$</div>
    <div style="text-align:center;margin-top:20px">$ f(x)=\\left\\{
      \\begin{aligned}
      x & =  \\cos(t) \\\\
      y & =  \\sin(t) \\\\
      z & =  \\frac xy
  ...
  <section style="margin-top: 1.5em; text-align: center;">
    <a href="/pages/docs/docs?index=0">内部链接</a>
